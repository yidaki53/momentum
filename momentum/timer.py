...
class RichTimerProgress:
    ...
    def __init__(
        ...
        *,
        ...
        from momentum.display import create_timer_progress, print_warning
...
class ConsoleEncouragement:
    ...
    def __init__(
        ...
        *,
        ...
        from momentum.display import console, print_nudge
        from momentum.encouragement import get_break_message, get_nudge

        self._focus_message = focus_message or get_nudge
        self._break_message = break_message or get_break_message
